...
export const EXPECTED_COLUMNS: Record<string, string[]> = {
  ...
  bot_settings: [
    ...
    "temporalDeploymentName", "temporalTlsEnabled", "temporalTlsServerName", "temporalImportDoneAt",
    ...
    "disputeResolveMode", "disputeAutoResolveEfw", "disputeAutoResolveMaxUsdMinor",
